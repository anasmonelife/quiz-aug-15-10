            ...
            <CardContent className="p-0">
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm text-muted-foreground">AZADI-2025 Quiz Competition Winner</p>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <h2 className="text-2xl font-bold text-blue-600 mb-3 tracking-wide">{winner.name}</h2>
                  ...
                  <div className="bg-gradient-to-r from-blue-100 to-pink-100 p-3 rounded-lg mb-3 border border-blue-200">
                    ...
                    <p className="text-sm text-muted-foreground">in the Quiz Competition</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  <div className="bg-blue-50 p-2 rounded border border-blue-200">
                    <div className="text-lg font-bold text-blue-600">{winner.score}/20</div>
                    <div className="text-xs text-muted-foreground">Score</div>
                  </div>
                  <div className="bg-pink-50 p-2 rounded border border-pink-200">
                    <div className="text-lg font-bold text-pink-600">{formatTime(winner.submissionTimeSeconds)}</div>
                    <div className="text-xs text-muted-foreground">Time</div>
                  </div>
                  <div className="bg-blue-50 p-2 rounded border border-blue-200">
                    <div className="text-sm font-bold text-blue-600">{winner.panchayath}</div>
